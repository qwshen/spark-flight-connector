This tutorial uses Dremio Community Edition v21.2.0 or above as the back-end Arrow-Flight server. Please follow the following steps to set up the environment:
